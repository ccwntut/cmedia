...
<html lang="en">
  ...
  <body>
    ...
    <hr>
    <form method="post" action="p9-5.php">
      <div class="container">
          <div class="row">
            <input name="t1" type="text" class="col-5 offset-1">
            <input type="submit" class="btn btn-danger col-3 offset-1" value="查詢書名顯示資料">
          </div>
      </div>
  </form>    
  ...
  <?php    
    ...
    //2.查詢資料表
    $result = $conn->query("select * from books  where 書籍名稱 = '".$str."'");
